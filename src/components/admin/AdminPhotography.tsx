...
export function AdminPhotography() {
    ...
    const [uploadCategory, setUploadCategory] =
        useState<PhotographyCategory>(DEFAULT_CATEGORY);
    ...
    /*
     * Load all photography records from Supabase.
     */
    ...
    /*
     * Sync URL segment with selected filter.
     */
    useEffect(() => {
        if (!requestedSegment) {
            setFilter('All');
        ...
        if (
            PHOTOGRAPHY_CATEGORIES.includes(
                requestedSegment as PhotographyCategory
            )
        ) {
            const category = requestedSegment as PhotographyCategory;
    ...
    /*
     * Select All or a photography category.
     */
    const selectFilter = (value: CategoryFilter) => {
        ...
        navigate(
            `/admin/photography?segment=${encodeURIComponent(value)}`,
            {
                replace: true,
            }
        );
    ...
    const handleAdd = async (files: FileList | null) => {
        ...
        try {
            ...
            /*
             * After uploading, immediately show the uploaded category.
             */
    ...
    const handleReplace = async (file: File | undefined) => {
        ...
        const current = photos.find(
            (photo) => photo.id === replaceId
        );
    ...
    const saveEdit = async () => {
        ...
        try {
            ...
            /*
             * Keep user on the edited category.
             */
            ...
            <div className="max-w-3xl space-y-6">
                <div>
                    ...
                    <p className="text-muted-foreground mt-1">
                        Manage photography by industry
                        segment.
                    </p>
                </div>
                ...
                <div className="bg-card border border-amber-500/30 rounded-2xl p-6">
                    ...
                    <p className="text-sm text-muted-foreground">
                        ...
                        and to Vercel Environment
                        Variables, then restart the
                        dev server.
                    </p>
                </div>
            </div>
    ...
    return (
        <div className="min-w-0 max-w-[1500px] space-y-7">
            ...
            <div className="flex flex-col xl:flex-row xl:items-end justify-between gap-5">
                <div className="min-w-0">
                    ...
                    <p className="text-muted-foreground mt-2 max-w-2xl">
                        Upload, replace, edit, and
                        remove photos without leaving
                        the selected industry segment.
                    </p>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-2 shrink-0">
                    <select
                        ...
                        onChange={(e) =>
                            setUploadCategory(
                                e.target.value as PhotographyCategory
                            )
                        }
            ...
            <div
                ...
                aria-label="Photography segments"
            >
                ...
                <div className="flex items-start gap-3">
                    ...
                    <div className="text-sm text-muted-foreground min-w-0">
                        ...
                        <p className="mt-1 leading-relaxed">
                            ...
                            up to 20 MB each. Images are
                            resized to 2400px maximum and
                            converted to WebP before
                            storage.
                        </p>
                    </div>
                </div>
            ...
            {loading ? (
                ...
                <div className="py-20 px-6 text-center border border-dashed border-border rounded-2xl bg-card/40">
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                        Choose this segment for uploads
                    ...
                    {hasMore && (
                        <div className="flex justify-center pt-2">
                            <button
                                ...
                                className="px-6 py-3 rounded-xl border border-border bg-card text-foreground font-semibold text-sm hover:bg-secondary transition-colors"
                            >
                                Load more photos
                            </button>
                        </div>
